      ...
      <Stack direction={{ lg: "row", base: "column", md: "row" }}>
        <DIV className="footerBox">
          <Stack spacing={3.5}>
            ...
            <Text fontSize={"12px"} letterSpacing={"0.5px"} padding={"0 30px"}>
        ...
        <DIV className="footerBox">
          ...
          <Box>
            <Text fontSize={"12px"} letterSpacing={"0.5px"} margin={"12px 0"}>
              Sign up for email and get insider access to exclusive offers, new
              arrivals, style tips and more
            </Text>
            <HStack>
              <Input
                type="email"
